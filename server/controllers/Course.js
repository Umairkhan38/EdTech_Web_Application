...
exports.createCourse = async(req,res)=>{
  ...
  try {
   ...
   let {courseName, courseDescription,instructions, whatYouWillLearn, price, tag, category, status } = req.body;
   ...
   if(!courseName|| !courseDescription || !whatYouWillLearn || !price || !tag || !thumbnail){
      ...
      // console.log("tagDetails are ",tagDetails);
      ...
      //  console.log("newCourse is ",newCourse);
       ...
       const updatedCourse = await User.findByIdAndUpdate(
           ...
           console.log("Updated Category is ",categoryDetails2);
